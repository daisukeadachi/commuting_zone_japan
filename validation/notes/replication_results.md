...
The cutoff sweep is the central exercise, and its result is the flatness the design anticipated. `similarity_vs_cutoff_2010_2020.png` shows the curve. Holding 2010 at 0.980 and varying the 2020 cutoff, mean similarity peaks at 0.845 at a cutoff of 0.978, and stays within 0.005 of that peak over the range 0.977 to 0.979, which spans 227 to 219 commuting zones. Anchoring 2010 at 0.977 instead moves the peak to 0.975 and the plateau to 0.974 to 0.977, spanning 240 to 227 zones. The two anchors therefore sit inside or immediately beside each other's plateau, and nothing in the objective distinguishes them. The same pattern holds for both control pairs.
