...
# commuting zones that code/build_us_compactness.R computes.
#
# Writes paper/statistics/diagnostics_table.csv and, for the contiguity diagnostics of
# issue #11, paper/statistics/noncontiguous_municipalities.csv.
