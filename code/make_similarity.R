...
#
# Writes paper/statistics/similarity_table.csv,
# paper/statistics/similarity_by_municipality.csv,
# paper/statistics/similarity_to_1980.csv and
# paper/statistics/cutoff_sweep.csv.
