...
#
# Writes derived/constrained_hclust_<year>.rds and
# derived/zones_constrained_<year>_cut<cutoff>.csv, neither committed, and
# paper/statistics/constrained_inversions.csv. All three carry the labour-force sample
