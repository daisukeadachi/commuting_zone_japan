...
#
# The core set and the externally defined areas come from the Urban Employment Area of
# Kanemoto and Tokuoka (2002), the delineation this literature uses. The three measures that
...
# rule only.
#
# Writes paper/statistics/core_table.csv, paper/statistics/core_area_splits.csv and
# the map of split areas under paper/figures.
