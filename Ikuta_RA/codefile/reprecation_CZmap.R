...
## (試行中)カスタムパレットでもう少し見やすい色で塗り分ける ####################

# neighbors <- spdep::poly2nb(CZ_2005.sf)
...
# 隣接関係の計算
neighbors <- poly2nb(CZ_2005.sf.temp)
neighbor_matrix <- nb2mat(neighbors, style = "B", zero.policy = TRUE)
