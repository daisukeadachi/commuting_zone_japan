...
for (y in year) {
  ...
  fileName <- base::paste0("output/map_image/TimeSeriesCZ/without_islands/", y, "_CZmap_harmonized.png")
  fileNameKanto <- base::paste0("output/map_image/TimeSeriesCZ/without_islands/", y, "_CZmap_harmonized_Kanto.png")
...
gridExtra::grid.arrange(CZ_1980, CZ_1985, CZ_1990, CZ_1995, CZ_2000, CZ_2005, CZ_2010, CZ_2015, nrow = 3) %>%
  ggplot2::ggsave(filename = "output/map_image/TimeSeriesCZ/without_islands/1980to2015_CZmap_harmonized.png", bg = "white")
...
gridExtra::grid.arrange(CZ_1980_Kanto, CZ_1985_Kanto, CZ_1990_Kanto, CZ_1995_Kanto,
  ...
  ggplot2::ggsave(filename = "output/map_image/TimeSeriesCZ/without_islands/1980to2015_CZmap_harmonized_kanto.png", bg = "white")
