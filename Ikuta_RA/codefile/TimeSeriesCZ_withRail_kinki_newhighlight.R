...
ggplot2::ggsave(somemaps, filename = "output/map_image/CZ/multiple/1980to2020_kinki_rail_newhighlight_original_CZmap.png", bg = "white")
...
ggplot2::ggsave(somemaps, filename = "output/map_image/CZ/multiple/1980to2020_kinki_rail_newhighlight_harmonized_CZmap.png", bg = "white", dpi = 600)
