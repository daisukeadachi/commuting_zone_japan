...
for (i in (1:length(path_list.McEA))){
  ...
  gridExtra::grid.arrange(UEAmap.Kanto, CZmap.Kanto, nrow = 1) %>%
    ggplot2::ggsave(filename = paste0("output/map_image/Railroad/Original/alt2/", year[i], "_Kanto_UEAandCZmap.png"),
                    bg = "white", width = 5, height = 3)
  ...
  gridExtra::grid.arrange(CZmap_rail, UEAmap_rail, nrow = 1) %>%
    ggplot2::ggsave(filename = paste0("output/map_image/Railroad/Original/alt2/", year[i], "_UEAandCZmap.png"),
                    bg = "white", width = 5, height = 3)
...
gridExtra::grid.arrange(grobs = UEA_map.kanto, nrow = 3) %>%
  ggplot2::ggsave(filename = "output/map_image/Railroad/Original/alt2/1980to2015_UEAmap_kanto.png", bg = "white")
gridExtra::grid.arrange(grobs = CZ_map.kanto, nrow = 3) %>%
  ggplot2::ggsave(filename = "output/map_image/Railroad/Original/alt2/1980to2015_CZmap_kanto.png", bg = "white")
gridExtra::grid.arrange(grobs = UEA_map, nrow = 3) %>%
  ggplot2::ggsave(filename = "output/map_image/Railroad/Original/alt2/1980to2015_UEAmap.png", bg = "white")
gridExtra::grid.arrange(grobs = CZ_map, nrow = 3) %>%
  ggplot2::ggsave(filename = "output/map_image/Railroad/Original/alt2/1980to2015_CZmap.png", bg = "white")
