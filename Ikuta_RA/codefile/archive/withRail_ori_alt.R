...
for (i in (1:length(path_list.McEA))){
  ...
  ggplot2::ggsave(joinedmap,filename = paste0("output/map_image/Railroad/Original_alt/Kanto/", year[i], "_Kanto_UEAandCZmap.png"), width = 5, height = 3, dpi = 900)
  ...
  ggplot2::ggsave(joinedmap,filename = paste0("output/map_image/Railroad/Original_alt/Whole/", year[i], "_Kanto_UEAandCZmap.png"), width = 5, height = 3, dpi = 900)
  ...
  if (i == 5) {
    ...
    ggplot2::ggsave(CZ1985, filename = "output/map_image/Railroad/Original_alt/Kanto/1985_Kanto_CZmap.png", width = 5, height = 3, dpi = 600)
    rm(CZ1985)
    CZ.sf %>%
      ggplot2::ggplot() +
      ggplot2::geom_sf(aes(fill = color), linewidth = .05, color = "gainsboro") +
      ...
      ggplot2::theme(legend.position = "none", 
                     plot.caption = element_text(size = 5, hjust = 0)) -> CZ1985
    ggplot2::ggsave(CZ1985, filename = "output/map_image/Railroad/Original_alt/Whole/1985_CZmap.png", width = 5, height = 3, dpi = 600)
    rm(CZ1985)
...
rm(UEA_map)
ggplot2::ggsave(map1980to2015, filename = "output/map_image/Railroad/Original_alt/multiple/1980to2015_UEAmap.png", bg = "white", dpi = 1200)
rm(map1980to2015)
...
rm(CZ_map)
ggplot2::ggsave(map1980to2015, filename = "output/map_image/Railroad/Original_alt/multiple/1980to2015_CZmap.png", bg = "white", dpi = 1200)
rm(map1980to2015)
...
rm(CZ_map.kanto)
ggplot2::ggsave(map1980to2015, filename = "output/map_image/Railroad/Original_alt/multiple/1980to2015_CZmap_kanto.png", bg = "white", dpi = 1200)
rm(map1980to2015)
...
rm(UEA_map.kanto)
ggplot2::ggsave(map1980to2015, filename = "output/map_image/Railroad/Original_alt/multiple/1980to2015_UEAmap_kanto.png", bg = "white", dpi = 1200)
