...
for (y in year){
 ...
 somemaps <- patchwork::wrap_plots(maps, nrow = 3)  +
  patchwork::plot_annotation(
    ...
    caption = "実線:在来線･点線:新幹線",
    theme = theme(plot.caption = element_text(size = 5, hjust = 0))
  )   
ggplot2::ggsave(somemaps, filename = "output/map_image/CZ/multiple/1980to2020_withRail_original_CZmap.png", bg = "white", dpi = 900)
rm(somemaps)
print("Original end")
...
ggplot2::ggsave(somemaps, filename = "output/map_image/CZ/multiple/1980to2020_withRail_harmonized_CZmap.png", bg = "white", dpi = 900)
