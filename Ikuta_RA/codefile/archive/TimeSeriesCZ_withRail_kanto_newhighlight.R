...
ggplot2::ggsave(somemaps, filename = "output/map_image/CZ/multiple/1980to2020_Kanto_rail_newhighlight_original_CZmap.png", bg = "white", dpi = 600)
rm(somemaps)
###
# harmonized ####
###
...
ggplot2::ggsave(somemaps, filename = "output/map_image/CZ/multiple/1980to2020_Kanto_Rail_newhighlight_harmonized_CZmap.png", bg = "white", dpi = 600)
