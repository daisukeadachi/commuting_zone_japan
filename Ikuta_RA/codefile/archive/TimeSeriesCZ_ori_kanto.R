...
ggplot2::ggsave(somemaps, filename = "output/map_image/CZ/multiple/1980to2020_kanto_original_CZmap.png", bg = "white", dpi = 600)
...
ggplot2::ggsave(somemaps, filename = "output/map_image/CZ/multiple/1980to2020_kanto_harmonized_CZmap.png", bg = "white", dpi = 600)
