...
ggplot2::ggsave(somemaps, filename = "output/map_image/CZ/multiple/1980to2020_original_CZmap.png", bg = "white", dpi = 900)
...
ggplot2::ggsave(somemaps, filename = "output/map_image/CZ/multiple/1980to2020_harmonized_CZmap.png", bg = "white", dpi = 900)
